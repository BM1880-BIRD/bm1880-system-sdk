...
static int bcm50612e_config_init(struct phy_device *phydev)
{
	int reg, err;
	...
	/* Set GTXCLK clock delay */
	bcm_phy_write_shadow(phydev, BCM54XX_SHD_CAC,
			BCM54XX_SHD_CAC_GTXCLK_DELAY);

	/* Set RDX to RXC clk delay */
	phy_write(phydev, MII_BCM54XX_AUX_CTL,
			MII_BCM54XX_AUXCTL_ENCODE(7));
	reg = phy_read(phydev, MII_BCM54XX_AUX_CTL);
	bcm54xx_auxctl_write(phydev, MII_BCM54XX_AUXCTL_SHDWSEL_MISCTL,
			(reg | MII_BCM54XX_AUXCTL_MCTL_WREN |
			MII_BCM54XX_AUXCTL_MCTL_RX_SKEW) &
			(~MII_BCM54XX_AUXCTL_MCTL_OFBS_DISABLE));
...
{
	.phy_id		= PHY_ID_BCM50612E,
	.phy_id_mask	= 0xfffffff0,
	.name		= "Broadcom BCM50612E",
	.features	= PHY_GBIT_FEATURES |
			  SUPPORTED_Pause | SUPPORTED_Asym_Pause,
	.flags		= PHY_HAS_MAGICANEG | PHY_HAS_INTERRUPT,
	.config_init	= bcm50612e_config_init,
