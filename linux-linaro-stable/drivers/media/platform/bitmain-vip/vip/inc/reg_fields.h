...
union REG_ISP_CROP_1 {
	uint32_t raw;
	struct {
		uint32_t TOP_CROP                        : 12;
		uint32_t _rsv_12                         : 4;
		uint32_t BOTTOM_CROP                     : 12;
	} bits;
};
...
union REG_ISP_CROP_2 {
	uint32_t raw;
	struct {
		uint32_t LEFT_CROP                       : 12;
		uint32_t _rsv_12                         : 4;
		uint32_t RIGHT_CROP                      : 12;
	} bits;
};
...
union REG_ISP_CROP_3 {
	uint32_t raw;
	struct {
		uint32_t IN_WIDTH                        : 12;
		uint32_t _rsv_12                         : 4;
		uint32_t IN_HEIGHT                       : 12;
	} bits;
};
...
union REG_ISP_AF_GAMMA_G_TABLE_WRITE {
	uint32_t raw;
	struct {
		uint32_t AF_GAMMA_G_TABLE_WRITE          : 1;
	} bits;
};

union REG_ISP_AF_GAMMA_G_TABLE_DATA {
	uint32_t raw;
	struct {
		uint32_t AF_GAMMA_G_TABLE_DATA           : 32;
	} bits;
};

union REG_ISP_AF_GAMMA_G_TABLE_CTRL {
	uint32_t raw;
	struct {
		uint32_t AF_GAMMA_G_TABLE_START          : 1;
		uint32_t _rsv_1                          : 3;
		uint32_t AF_GAMMA_G_TABLE_W              : 1;
		uint32_t _rsv_5                          : 3;
		uint32_t AF_GAMMA_G_TABLE_DONE           : 1;
	} bits;
};
...
union REG_ISP_RGBMAP_0 {
	...
	struct {
		...
		uint32_t _rsv_7                          : 1;
		uint32_t IMG_BAYERID                     : 2;
		uint32_t RGBMAP_W_GRID_NUM               : 9;
		uint32_t RGBMAP_H_GRID_NUM               : 9;
		uint32_t _rsv_28                         : 2;
...
union REG_ISP_LTM_TILE_MODE_CTRL_0 {
	uint32_t raw;
	struct {
		uint32_t DMA_BLK_SKIP                    : 8;
		uint32_t BLK_WIN_SKIP                    : 8;
		uint32_t RS_OUT_SKIP                     : 16;
	} bits;
};
...
/*           Module Definition            */
/******************************************/
union REG_ISP_UV_DITHER_RGB_DITHER {
	uint32_t raw;
	struct {
		...
		uint32_t UV_DITHER_SHDW_SEL              : 1;
		uint32_t UV_DITHER_SOFTRST               : 1;
		uint32_t UV_DITHER_HEIGHTM1              : 12;
		uint32_t UV_DITHER_WIDTHM1               : 12;
	} bits;
};

union REG_ISP_UV_DITHER_DEBUG_00 {
	uint32_t raw;
	struct {
...
union REG_ISP_TOP_14 {
	uint32_t raw;
	struct {
		uint32_t FORCE_FRAME_DONE_PRE            : 1;
		uint32_t FORCE_FRAME_DONE_PRE1           : 1;
		uint32_t FORCE_FRAME_DONE_POST           : 1;
		uint32_t FORCE_SHAW_DONE_PRE             : 1;
		uint32_t FORCE_SHAW_DONE_PRE1            : 1;
		uint32_t FORCE_SHAW_DONE_POST            : 1;
		uint32_t FORCE_FRAME_ERR_PRE             : 1;
		uint32_t FORCE_FRAME_ERR_PRE1            : 1;
		uint32_t FORCE_FRAME_ERR_POST            : 1;
		uint32_t FORCE_CMDQ1_INT                 : 1;
		uint32_t FORCE_CMDQ2_INT                 : 1;
		uint32_t FORCE_CMDQ3_INT                 : 1;
	} bits;
};
