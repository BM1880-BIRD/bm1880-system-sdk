...
struct VREG_ISP_AF_GAMMA_G_TABLE_WRITE {
	union REG_ISP_AF_GAMMA_G_TABLE_WRITE    write;
	union CMDSET_FIELD                      ctrl;
};

struct VREG_ISP_AF_GAMMA_G_TABLE_DATA {
	union REG_ISP_AF_GAMMA_G_TABLE_DATA     write;
	union CMDSET_FIELD                      ctrl;
};

struct VREG_ISP_AF_GAMMA_G_TABLE_CTRL {
	union REG_ISP_AF_GAMMA_G_TABLE_CTRL     write;
	union CMDSET_FIELD                      ctrl;
};
...
struct VREG_ISP_AF_T {
	...
	struct VREG_ISP_AF_GAMMA_G_TABLE_WRITE   GAMMA_G_TABLE_WRITE;
	struct VREG_ISP_AF_GAMMA_G_TABLE_DATA    GAMMA_G_TABLE_DATA;
	struct VREG_ISP_AF_GAMMA_G_TABLE_CTRL    GAMMA_G_TABLE_CTRL;
...
struct VREG_ISP_FPN_T {
	...
	struct VREG_RESV                        _resv_0x18[11];
...
/*           Module Definition            */
/******************************************/
struct VREG_ISP_UV_DITHER_RGB_DITHER {
	union REG_ISP_UV_DITHER_RGB_DITHER      write;
	union CMDSET_FIELD                      ctrl;
};

struct VREG_ISP_UV_DITHER_DEBUG_00 {
	union REG_ISP_UV_DITHER_DEBUG_00        write;
	union CMDSET_FIELD                      ctrl;
};

struct VREG_ISP_UV_DITHER_T {
	struct VREG_ISP_UV_DITHER_RGB_DITHER     RGB_DITHER;
	struct VREG_ISP_UV_DITHER_DEBUG_00       DEBUG_00;
};
...
struct VREG_ISP_DCI_T {
	...
	struct VREG_RESV                        _resv_0x50[44];
