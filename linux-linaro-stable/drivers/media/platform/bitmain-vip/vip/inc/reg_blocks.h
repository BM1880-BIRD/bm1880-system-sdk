...
struct REG_ISP_LSCR_T {
	...
	uint32_t                                _resv_0x11c[952];
	union REG_ISP_LSCR_DUMMY                DUMMY;
};
...
struct REG_ISP_AF_T {
	...
	union REG_ISP_AF_GAMMA_G_TABLE_WRITE    GAMMA_G_TABLE_WRITE;
	union REG_ISP_AF_GAMMA_G_TABLE_DATA     GAMMA_G_TABLE_DATA;
	union REG_ISP_AF_GAMMA_G_TABLE_CTRL     GAMMA_G_TABLE_CTRL;
...
/*           Module Definition            */
/******************************************/
struct REG_ISP_UV_DITHER_T {
	union REG_ISP_UV_DITHER_RGB_DITHER      RGB_DITHER;
	union REG_ISP_UV_DITHER_DEBUG_00        DEBUG_00;
};
