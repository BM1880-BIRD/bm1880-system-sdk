...
static int bm_core_init_mode(struct platform_device *pdev)
{
#if 0
	...
	iowrite32(0x0A, ioremap(0x50080000, 0x4));
#endif
#if 0
	// open VBUS_5V
	// GPIO0 out 1
	// pinmux
	iowrite32((ioread32((void *)ioremap(0x500104E0, 0x4)) & ~0x300000), (void *)ioremap(0x500104E0, 0x4));
	// out
	iowrite32((ioread32((void *)ioremap(0x50027004, 0x4)) | 0x1), (void *)ioremap(0x50027004, 0x4));
	// 1
	iowrite32((ioread32((void *)ioremap(0x50027000, 0x4)) | 0x1), (void *)ioremap(0x50027000, 0x4));
	mdelay(100);

	// 资源申请需要移动到probe的位置
	//res = platform_get_resource(pdev, IORESOURCE_MEM, 1);
	//regs48 = devm_ioremap_resource(&pdev->dev, res);

	// External VBUS valid. (external_vbusvalid)
	//writel(readl(regs48) | (1 << UPCR_EXTERNAL_VBUS_VALID_OFFSET), regs48);
	iowrite32((ioread32(ioremap(0x50010048, 0x4)) | (1 << UPCR_EXTERNAL_VBUS_VALID_OFFSET)),
...
int xhci_bitmain_init_quirk(struct usb_hcd *hcd)
{

	if (usb_hcd_is_primary_hcd(hcd))
		bm_core_init_mode(to_platform_device(hcd->self.controller));
	return 0;
}
...
static const struct xhci_plat_priv xhci_plat_bitmain = {
	.init_quirk = xhci_bitmain_init_quirk,
};
