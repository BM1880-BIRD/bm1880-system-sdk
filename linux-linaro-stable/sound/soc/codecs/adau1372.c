...
static const struct reg_default adau1372_reg_defaults[] = {
	...
	{ ADAU1372_REG_CLKOUT_SEL,		0x01 }, //
	{ ADAU1372_REG_DAC_SOURCE,		0xDC }, // Set output as Stereo
	{ ADAU1372_REG_SOUT_SOURCE_0_1,		0x55 }, // Set AIN1/1 to be default input, set 0x76 if want AIN2/3
	{ ADAU1372_REG_SOUT_SOURCE_2_3,		0x44 }, //
	{ ADAU1372_REG_SOUT_SOURCE_4_5,		0x44 }, //
	{ ADAU1372_REG_SOUT_SOURCE_6_7,		0x44 }, //
	...
	{ ADAU1372_REG_PGA_CTRL(0),		0x22 },
	{ ADAU1372_REG_PGA_CTRL(1),		0x13 },
	{ ADAU1372_REG_PGA_CTRL(2),		0x2D },
	{ ADAU1372_REG_PGA_CTRL(3),		0x2D },
	...
	{ ADAU1372_REG_SAI1,			0x81 },
	{ ADAU1372_REG_SOUT_CTRL,		0xFC },
	{ ADAU1372_REG_MODE_MP(0),		0x00 },
	{ ADAU1372_REG_MODE_MP(1),		0x00 }, //
	{ ADAU1372_REG_MODE_MP(4),		0x11 },
	{ ADAU1372_REG_MODE_MP(5),		0x10 },
	{ ADAU1372_REG_MODE_MP(6),		0x12 }, //
	{ ADAU1372_REG_PB_VOL_SET,		0X10 },
	{ ADAU1372_REG_PB_VOL_CONV,		0x82 },
	{ ADAU1372_REG_DEBOUNCE_MODE,	0x03 },
