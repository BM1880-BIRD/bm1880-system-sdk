...
static int bcm54616s_startup(struct phy_device *phydev)
{
	int reg;
	int i = 0;
	...
	printf("Waiting for Serdes link up");
	while (!(reg & BIT(9))) {
		/*
		 * Timeout reached ?
		 */
		...
		udelay(1000);	/* 1 ms */
		reg = phy_read(phydev, MDIO_DEVAD_NONE, MIIM_BCM54XX_SHD);
	}
...
static struct phy_driver BCM50612E_driver = {
	.name = "Broadcom BCM50612E",
	.uid = 0x3625E62,
	.mask = 0xfffff0,
	.features = PHY_GBIT_FEATURES,
	.config = &bcm50612e_config,
