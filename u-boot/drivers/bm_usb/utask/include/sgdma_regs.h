...
#define TDF_CHAIN_BIT           0x00000010L /* Set automatically by TD Generator*/
...
#define BUILD_NORMAL_TRB(_trb, _data_ptr, _data_size, _stream_id) { \
	_trb.dmaAddr  = cpuToLe32(_data_ptr); \
	_trb.dmaSize = cpuToLe32((_data_size) | PRECISE_BURST_LENGTH); \
	_trb.ctrl = cpuToLe32(((uint32_t)(_stream_id) << 16) | \
				(TD_TYPE_NORMAL | TDF_CYCLE_BIT | TDF_INT_ON_COMPLECTION | TDF_INT_ON_SHORT_PACKET)); }
